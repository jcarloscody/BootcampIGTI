    ...
    if (databaseUser) {
        ...
        if (pwdMatches) {
            ...
            const jwtToken = jwt.sign(
                { role: databaseUser.role, curso: 'Node Módulo 2' },
                privateKey,
                { expiresIn: 300, algorithm: 'RS256' })  //vamos assinar um token, vamos assinar uma determinada informação, e com isso vamos criar um token jwt
