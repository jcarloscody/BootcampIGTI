...
import basicAuth from 'express-basic-auth'; //biblioteca que faz autenticacao basica
...
//uma forma hard code de colocar o user e password dos usuarios para autenticacao basica
/*app.use(basicAuth({
    users: { 'adminU': 'adminS' }
}))*/

//uma forma dinamica de colocar o user e password dos usuarios para autenticacao basica
//aqui ainda está hard code, mas possibilita vc a fazer uma conexao com algo no lugar de pôr uma string
app.use(basicAuth({
